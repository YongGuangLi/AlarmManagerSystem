                          ...
                          const QString &normalTextColor, const QString &darkTextColor)
{
    ...
    QStringList qss;
    qss.append(QString("QAbstractButton{border-style:none;border-radius:0px;padding:5px;color:%1;background:%2;}")
               .arg(normalTextColor).arg(normalBgColor));

    qss.append(QString("QAbstractButton:hover,"
                       "QQAbstractButton:pressed,"
                       "QAbstractButton:checked{"
                       "border-style:solid;%1border-color:%2;color:%3;background:%4;}")
                       .arg(strBorder).arg(borderColor).arg(darkTextColor).arg(darkBgColor));
                          ...
                          const QString &normalTextColor,  const QString &darkTextColor)
{
    ...
    if (btns.at(0)->toolButtonStyle() == Qt::ToolButtonTextBesideIcon) {
        qss.append(QString("QWidget[flag=\"%1\"] QAbstractButton{border-style:solid;border-radius:0px;padding:5px;}") //background:%5;
                   .arg(type));   //.arg(strBorder)
    } else {
        qss.append(QString("QWidget[flag=\"%1\"] QAbstractButton{border-style:none;border-radius:0px;padding:5px;}") //background:%3;
                   .arg(type));
    }
    ...
    qss.append(QString("QWidget[flag=\"%1\"] QAbstractButton:hover,"
                       ...
                       "border-style:solid;%2border-color:%3;}")
                       .arg(type).arg(strBorder).arg(borderColor));
